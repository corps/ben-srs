...
export const StudyContext = createContext([defaultStudyContext, () => null] as [
  StudyContextData,
  Dispatch<StudyContextData | ((sd: StudyContextData) => StudyContextData)>
]);
export const RouteContext = createContext((() => []) as Dispatch<
  (v: Maybe<ReactElement>) => Maybe<ReactElement>
>);
export const TriggerSyncContext = createContext([() => null, 0] as [
  () => void,
  number
]);
