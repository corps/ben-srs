...
export function CircleButton(
  props: React.PropsWithChildren<CircleButtonProps>
) {
  return (
    <div className={circleClassNames(props)} onClick={props.onClick}>
      <div className="dt w4 h4 f2-ns f4">
        <div className="dtc v-mid tc white">{props.children}</div>
      </div>
    </div>
  );
}
